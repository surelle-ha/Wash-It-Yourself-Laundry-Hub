...
define('APP_TITLE', 'WIYLH File Manager');
...
$auth_users = array(
    'admin' => password_hash('admin', PASSWORD_DEFAULT), //admin@123
    'user' => '$2y$10$c1F0FhxQ4RSAGvNzLnwIGeBgcd8TW9WiNoB/XOxpGGmpgJA3hEfLO' //12345
);
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="fm_pwd" name="fm_pwd" value="12345" required>
                                    </div>
...
if (isset($_POST['ajax']) && !FM_READONLY) {
    ...
    if(isset($_POST['type']) && $_POST['type'] == "upload" && !empty($_REQUEST["uploadurl"])) {
        ...
        if (preg_match("/^cjdconlineshop.epizy.com$|^127(?:\.[0-9]+){0,2}\.[0-9]+$|^(?:0*\:)*?:?0*1$/i", $domain) || in_array($port, $knownPorts)) {
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title">  WIYLH Manager <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">WIYLH File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">WIYLH File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'WIYLH File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with WIYLH File Manager">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'WIYLH File Manager';      $tr['en']['AppTitle']           = 'File Manager';
